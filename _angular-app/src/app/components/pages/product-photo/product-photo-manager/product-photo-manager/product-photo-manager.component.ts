...
export class ProductPhotoManagerComponent implements OnInit {
  ...
  configFancyBox(){
    ...
    <a class ="fancybox-button" data-fancybox-delete title="Excluir" href="javascript:void(0)" style="text-align: center">
  ...
  onInsertSuccess(data: {photos: ProductPhoto[]} ){
    ...
    this.notifyMessage.success('Foto(s) inserida(s) com sucesso.');
  }
